...
Article.create!(price: 50, title: "When did Paxman go from supreme interviewer to shouty interrupter?", summary: "I used to idolise ‘Paxo’, with his dogged pursuit of slippery interviewees. But his treatment of May and Corbyn was cringey and disrespectful to viewers", url: "https://www.theguardian.com/commentisfree/2017/may/30/jeremy-paxman-politician-theresa-may-jeremy-corbyn", user: User.last)
Article.create!(price: 27, title: "Admit it, Theresa May: ‘no deal’ is not an option in the Brexit talks", summary: "Threatening to walk away from the coming negotiations may appear to be tactically sound, but EU leaders know it is nonsense", url: "https://www.theguardian.com/commentisfree/2017/may/30/theresa-may-no-deal-brexit-talks-eu", user: User.last)
Article.create!(price: 27, title: "Conservative MP dismisses disabled woman who tells him 'tens of thousands of people are dying'", summary: "Dominic Raab tells disability activist putting more funding into health and social care is 'just a childish wish list' unless there is a strong economy", url: "http://www.independent.co.uk/news/uk/home-news/disabled-disablility-dominic-raab-dying-conservative-fiona-victoria-derbyshire-a7761291.html", user: User.last)
