...
# Article.create!(price: 10, title: "The Rise Of Auto-Complete Culture - And Why We Should Resist", summary: "Google wants to optimize self-expression and make us all sound the same.", url: "https://www.fastcodesign.com/90126569/the-rise-of-autocomplete-culture", user: User.find_by(name: ))
...
# Article.create!(price: 8, title: "Admit it, Theresa May: ‘no deal’ is not an option in the Brexit talks", summary: "Threatening to walk away from the coming negotiations may appear to be tactically sound, but EU leaders know it is nonsense", url: "https://www.theguardian.com/commentisfree/2017/may/30/theresa-may-no-deal-brexit-talks-eu", user: User.last)
